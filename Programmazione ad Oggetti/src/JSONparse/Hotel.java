...
public class Hotel implements Serializable {
	...
	public Hotel(String structureType, String businessType, String classification, String denomination, int CAP, String address, String tel, int room, int toilet, int bed, String scia_aut, String data, String prenotation, String duration) {
